...
\begin{statement}[из топологии]
    \begin{enumerate}
        \item $(X, \rho)$ -- метрическое пространство, $K \subseteq X$, $K$ -- компакт $\Leftrightarrow K$ -- счётно-компактен, то есть 
...
\begin{definition}[относительный компакт]
    $(X, \rho), A \subseteq X, A$ -- относительно компактно, если $\overline{A}$ -- компакт.
    Или можно сказать 
...
\begin{definition}[$\varepsilon$-сеть]
    $(X, \rho)$ -- метрическое пространство. $A \subseteq X, \varepsilon > 0$ \\
    $F$ -- $\varepsilon$-сеть для $A$, если 
    \begin{multline*}
        \forall a \in A \, \exists f \in F: \rho(a,f) < \varepsilon \\
        (\Leftrightarrow \, \forall a \in A B_\varepsilon(a) \cap F \ne \varnothing) \Leftrightarrow (A \subseteq \bigcup_{f \in F} B_{\varepsilon}(f))
    \end{multline*}
\end{definition}
...
\begin{example}
    $(\bR^n, || \cdot ||_2) = l^2_n \quad A \subseteq \bR^n$. $A$ -- ограниченное $\Leftrightarrow A$ вполне ограниченное
\end{example}

\begin{proof}
    $A$ -- ограниченное $\Leftrightarrow$ $\exists M > 0, \, \forall x - (x_1, \ldots, x_n) \in A \Rightarrow |x_j| \leq M$ \\
    $A \subseteq \bQ = \seq{ |x_j| \leq M, 1 \leq j \leq n}$
...
\begin{example}
    $D \subseteq l^2, D = \seq{x \in l^2: ||x||_2 \leq 1}$
...
\begin{proof}
    \begin{gather*}
        ...
        \seq{f_n}^\infty_{n=1} \subseteq F \Rightarrow F \text{ -- не конечное}
    \end{gather*}
...
\begin{example}
    $ \Pi = \seq{x = \seq{x_n}^\infty_{n=1}, \, |x_n| < \frac{1}{2^n}} \subseteq l^2$.
    ...
    $\Pi^* \subseteq \bR^n$, $\Pi^*$ -- ограниченное $\Rightarrow$ вполне ограниченное $\Rightarrow$ 
    $\exists F \subseteq \Pi^*$ -- конечная $\varepsilon$-сеть. \\
...
\begin{property}
    \begin{enumerate}
        ...
        \item $A \subseteq Y \subseteq X, A$  -- вполне ограничено в $X \Rightarrow$  $A$ -- вполне ограниченное в $Y$.
        \item $A$ -- вполне ограничено $\Rightarrow (A, \rho)$ -- сепарабельно.
    \end{enumerate}
\end{property}

\begin{proof}[1 свойство]
    $A \subseteq X, \varepsilon > 0$. $F$ -- конечная $\varepsilon$-сеть для $A$. Проверим, что
...
\begin{proof}[2 свойство]
    ...
    $A \subseteq Y \subseteq X, \varepsilon > 0, \seq{x_k}^n_{k=1}$ -- $\varepsilon$-сеть для $A$, $x_k \in X$ \\
    $A \subseteq \bigcup^n_{k=1} B_\varepsilon(x_k)$, если $A \cap B_\varepsilon(x_k) \ne \varnothing$, то
    ...
    \begin{multline*}
        ...
        E \text{ -- } (2\varepsilon)\text{-сеть для } A, E \subseteq A
    \end{multline*}
\end{proof}

\begin{proof}[3 свойство]
    $n \in \bN, F_n$ -- $\left( \frac{1}{n} \right)$-сеть для $A$, $F_n$ -- конечное.
    \[ F \text{ (счетное )} = \bigcup^\infty_{n=1} F_n \text{ -- плотно в } A, \text{ то есть } A \subseteq \overline{F} \]
\end{proof}

\begin{statement}[о разбиении]
    $(X, \rho), A \subseteq X, \varepsilon > 0$. $F$ -- конечная $\varepsilon$-сеть для $A \Rightarrow$ 
...
\begin{proof}
    \begin{gather*}
        F = \seq{x_k}^n_{k=1}, A \subseteq \bigcup^n_{k=1} B_\varepsilon(x_k) \\
    ...
    \end{gather*}
    если $C_k = \varnothing$, то забудем о нём. $C_k \subseteq B_{\varepsilon(x_k)} \Rightarrow \diam C_k \leq 2 \varepsilon$
\end{proof}
...
\begin{theorem}[Хаусдорф]
    $(X,\rho)$ -- метрическое пространство, $A \subseteq X$. \\

    $A$ -- компакт $\Leftrightarrow$
    \begin{enumerate}
        \item   $A \text{ полное, то есть } \forall \seq{x_n}^\infty_{n=1} \subseteq A, \seq{x_n} \text{ -- фундаментальная } \exists \lim x_n = x_0 \in A$ 
...
\begin{proof}
    ...
    \begin{gather*}
        \text{пусть } \varepsilon > 0 \quad A \subseteq \bigcup_{a \in A} B_\varepsilon(a) \land A \text { -- компакт } \Rightarrow , \exists \seq{a_j}^n_{j=1}, a_j \in A : \\
        A \subseteq \bigcup^n_{j=1} B_\varepsilon(a_j) \Rightarrow F = \seq{a_j}^n_{j=1} \text{ -- } \varepsilon\text{-сеть для } A
    \end{gather*}
    ...
    \begin{gather*}
        ...
        \text{ и так далее } \seq{A_m}^\infty_{m=1}, A_{m+1} \subseteq A_m, \diam_{A_m} \leq \frac{1}{2^m} \\
        ...
        \seq{x_{n_k}}^\infty_{k=1}, x_{n_k} \in A_k, \diam A_k \underset{k \to \infty}{\longrightarrow} 0 \quad A_{k+1} \subseteq A_k \\
...
\begin{corollary}
    $(X, \rho)$ -- метрическое, $A \subseteq X$. 
    \begin{enumerate}
...
\begin{proof}[1 утверждение]
    ...
    $\overline{A}$ -- вполне ограничено, $A \subseteq \overline{A} \Rightarrow A$ вполне ограничено.
\end{proof}
...
\begin{corollary}
    $(X, \rho)$ -- полное, $A \subseteq X$. Если для $\forall \varepsilon > 0 \, \exists$ относительно компактная $\varepsilon$-сеть, то
...
\begin{definition}
    $(K, \rho)$ -- метрический компакт.
     $C(K) = \seq{f: K \rightarrow \bR (\bC), f \text{ -- непрерывная}}, ||f|| = \max_{x \in K} |f(x)| \Phi \subseteq C(K)$.
...
\begin{theorem}[Асколи-Арцелла]
    $K$ -- компакт, $(K, \rho)$, $\Phi \subseteq C(K)$. $\Phi$ -- относительно компактно $\Leftrightarrow$ 
    \begin{enumerate}
...
\begin{proof}
    ...
    1. $\Phi \subseteq C(K)$, а $C(K) \subseteq m(K)$, и
    ...
    \[ \varepsilon > 0 \quad \Phi \subseteq C(K) \subseteq m(K) = \{ f: K \rightarrow \bC, \sup_{x \in K} |f(x)| < + \infty \} \]
    ...
    \begin{gather*}
        ...
        \Psi = \left\{ g(x) = \sum^n_{j=1} y_j \chi_{C_j} (x)  \right\} \subseteq m(K), y_j \in \bC, 1 \leq j \leq n \\
...
\begin{theoremwobox}[достаточные условия равностепенной непрерывности]
    $(K, \rho)$ -- компакт, $\Phi \subseteq C(K)$.
    ...
    \begin{enumerate}
        ...
        \end{multline*}
        \item $C[a,b], \Phi \subseteq C[a,b]$, пусть $\exists L > 0$ 
        \[ \forall f \in \Phi \, \exists f^\prime(x), x \in (a,b), |f^\prime(x)| \leq L \Rightarrow \Phi \in (EC) \]
        \item чуть более общий случай. $K \subseteq G \subseteq \bR^n$, $K$ -- компакт, $G$ -- открытое.
        ...
        $K \subseteq G \subseteq \bC$, $G$ -- открытое, $K$ -- компакт. 
...
\begin{proof}[2]
    $\Phi \subseteq C[a,b], \, x,y \in [a,b], f \in \Phi$. Для оценки разности $f(x) - f(y)$ воспользуемся теоремой Лагранжа. 
    \begin{multline*}
...
\begin{proof}[3]
    Пусть $z, y \in K$ такие что $[z,y] \subseteq G, f \in \Phi$ 
Оценим разность $f(y) - f(z)$. 
    ...
    \begin{gather*}
        ...
        \forall x \in K \, B_r(x) \subseteq G, \beta = r \\
        \rho(x,y) < r \Rightarrow y \in B_r(x) \subseteq G \Rightarrow \\
        \text{ отрезок } [x,y] B_r(x) \subseteq G \\
...
\begin{proof}[4]
    Букву $r$, которую мы нашли в предыдущем пункте, будем изо всех сил использовать. $K \subseteq G \subseteq \bC$. В 3 пункте выяснили, что 
    $\exists r > 0: B_r(x) \subseteq G \, \forall x \in K, \beta = \frac{r}{3}$.
    \begin{gather*}
...
\begin{statement}
    $1 \leq p < + \infty$. $\Phi \subseteq l^p, \Phi$ -- относительно компактно $\Leftrightarrow$ 
    \begin{enumerate}
...
\end{statement}
\begin{statement}
    $\Phi \subseteq C_0, \Phi$  -- относительно компактно $\Leftrightarrow$ 
    \begin{enumerate}
        \item $\Phi$ -- ограничено \\
