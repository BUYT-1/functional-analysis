...
\end{gather*}
 ...
 \begin{example}
    ...
    $(x,y) \in F, (x,y) = \sum^\infty_{j=1} x_j \overline{y_j}$ (конечная сумма $F \subseteq l^2, \norm{x} = \sqrt{\sum^N_{j=1} \abs{x_j}^2}), x_{N+k} = 0 \: k \in \bN$.
 ...
 \begin{example}
    $\Rho, \Rho \subseteq C[a,b]$. $(p,q) = \int^b_a p(x) \overline{q(x)} dx$ --- предгильбертово, пополнением $\Rho$ будет $L^2(a,b)$ по мере Лебега.
 \end{example}
 ...
 \begin{definition}
    ...
    \begin{enumerate}
        ...
        \item $M \subseteq H, M$ --- подмножество. Ортогональным дополнением к нему будем называть \\
        \[ M^\perp  = \seq{y \in H: (y,x) = 0 \: \forall x \in M }\]
    \end{enumerate}
 \end{definition}

\begin{property}
    $M \subseteq H$ --- гильбертово $\Rightarrow M^\perp$ --- замкнутое подпространство
\end{property}
...
\begin{theorem}[о существовании элемента наилучшего приближения в гильбертовом пространстве]
    $H$ --- гильбертово, $M \subseteq H, M$ --- замкнутое подпространство, $\forall x \in H \Rightarrow \: \exists! z \in M : \norm{x-z} = \min_{h \in M} \norm{x-h} = \rho(x,M)$
\end{theorem}
...
\begin{lemma}
    $H$ --- гильбертово, замкнутое подпространство $M \subseteq H$. $x \in H \setminus M, \: u,v \in M, \: d = \inf_{h \in M} \norm{x-h} $
    \[ \Rightarrow \norm{u-v}^2 \leq 2(\norm{u-x}^2 + \norm{v-x}^2) - 4d^2 \]
\end{lemma}
\begin{proof}
...
\begin{theorem}[о проекции на подпространство]
    $H$ --- гильбертово, $M \subseteq H$, $M$ --- замкнутое подпространство 
...
\begin{corollary}[ортогональный оператор на конечномерное подпространство]
    $H$ ---  гильбертово, подпространство $M \subseteq H, \dim M = n, n \in \bN$
    \begin{gather*}
...
\begin{proof}
    ...
    \begin{gather*}
        ...
        \Rightarrow \norm{x - s_n} \leq \norm{x-y} < \varepsilon \quad L_n \subseteq L_{n+1} \Rightarrow \\
...
Упражнение: $c = \seq{x = \seq{x_n}^\infty_{n=1}, \: \exists \liml_{n \to \infty} x_n = x_0} \subseteq l^\infty$. Что тут будет базисом?
